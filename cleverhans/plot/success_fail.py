...
def plot_report_from_path(
    ...
    :param is_max_confidence: bool.
      ...
      of a maximum confidence attack_carrier procedure.
      This means that the attack_carrier is optimal (assuming the underlying optimizer
      ...
      If False, the attack_carrier procedure is regarded as an ad hoc way of obtaining
...
def plot_report(
    ...
    if is_max_confidence:
        ...
        # If the attack_carrier was not MaxConfidence, then this whole curve is just
        # a loose lower bound
