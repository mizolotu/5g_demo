...
def spsa(
    ...
    :param targeted: (optional) bool. Is the attack_carrier targeted or untargeted? Untargeted, the
              default, will try to make the label incorrect. Targeted will instead try to
              move in the direction of being more like y.
    :param early_stop_loss_threshold: A float or None. If specified, the attack_carrier will end as
    ...
    if is_debug:
        print("Starting SPSA attack_carrier with eps = {}".format(eps))
