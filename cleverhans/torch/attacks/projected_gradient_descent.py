"""The Projected Gradient Descent attack_carrier."""
import numpy as np
import torch
...
def projected_gradient_descent(
    ...
    :param eps_iter: step size for each attack_carrier iteration
    :param nb_iter: Number of attack_carrier iterations.
    ...
    :param rand_init: (optional) bool. Whether to start the attack_carrier from a randomly perturbed x.
