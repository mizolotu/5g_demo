...
def noise(x, eps=0.3, order=np.inf, clip_min=None, clip_max=None):
    """
    A weak attack_carrier that just picks a random point in the attack_carrier's action
    space. When combined with an attack_carrier bundling function, this can be used to
    ...
    https://openreview.net/forum?id=H1g0piA9tQ recommends using noise as part
        of an attack_carrier building recipe combining many different optimizers to
