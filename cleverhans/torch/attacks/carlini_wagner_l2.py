...
def carlini_wagner_l2(
    ...
    :param y: (optional) Tensor with true labels. If targeted is true,
              ...
              Default is None.
    :param targeted: (optional) bool. Is the attack_carrier targeted or
              untargeted? Untargeted, the default, will try to make the
              label incorrect. Targeted will instead try to move in the
              direction of being more like y.
    :param lr: (optional) float. The learning rate for the attack_carrier
    ...
    def compare(pred, label, is_logits=False):
        ...
        Returns true if the attack_carrier is considered successful.
    ...
    for outer_step in range(binary_search_steps):
        ...
        # Inner loop performing attack_carrier iterations
        for i in range(max_iterations):
            # One attack_carrier step
