...
def get_or_guess_labels(model, x, **kwargs):
    ...
    The kwargs are fed directly from the kwargs of the attack_carrier.
    If 'y' is in kwargs, then assume it's an untargeted attack_carrier and
    use that as the label.
    If 'y_target' is in kwargs and is not none, then assume it's a
    targeted attack_carrier and use that as the label.
