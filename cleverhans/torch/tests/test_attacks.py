...
from cleverhans.devtools import CleverHansTest
...
from cleverhans.torch import sparse_l1_descent
...
class TestFastGradientMethod(CommonAttackProperties):
    ...
    def test_eps(self):
        # test if the attack_carrier respects the norm constraint
    ...
    def test_adv_example_success_rate_linf(self):
        # use normalized_x to make sure the same eps gives uniformly high attack_carrier
...
class TestProjectedGradientMethod(CommonAttackProperties):
    ...
    def test_adv_example_success_rate_l1(self):
        ...
        # TODO uncomment the actual test below after we have implemented the L1 attack_carrier
...
class TestSparseL1Descent(CommonAttackProperties):
    ...
    def test_do_not_reach_lp_boundary(self):
        """
        Make sure that iterative attack_carrier don't reach boundary of Lp
